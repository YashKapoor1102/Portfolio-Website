  ...
  const experiences = [
    {
      ...
      description: [
        ...
        "Trained and tuned an Azure Document Intelligence model to extract structured invoice fields and added validation rules to improve data accuracy and reduce manual correction effort.",
        "Designed and implemented containerized services using Docker (and Kubernetes where applicable), improving deployment consistency and supporting safer rollout practices.",
        // Palantir (keep at very bottom)
                      ...
                      {openTab.includes(`${exp.company}-${category}`) && (
                        <div className="p-4 bg-blue-100">
                          <ul className="list-disc pl-6 mt-2">
                            {exp.categories[
                              category as keyof typeof exp.categories
                            ].map((item, j) => (
