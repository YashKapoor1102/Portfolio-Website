                  ...
                  {Object.keys(exp.categories).map((category, i) => (
                    ...
                    >
                      <button
                        ...
                        className="text-left w-full bg-blue-200 hover:bg-blue-300 rounded-lg py-2 px-4 font-semibold text-blue-700 border border-blue-500 flex items-center gap-2"
                      >
                        {openTab.includes(`${exp.company}-${category}`) ? (
                      ...
                      {openTab.includes(`${exp.company}-${category}`) && (
                        <div className="p-4 bg-blue-100">
                          <ul className="list-disc pl-6 mt-2">
                            {exp.categories[category as keyof typeof exp.categories].map(
                              (item, j) => (
