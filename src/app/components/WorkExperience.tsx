  ...
  const experiences = [
    {
      ...
      description: [
        ...
        "Designed and implemented a full-stack Fleet application and invoice processing pipeline using Figma, React, Node.js, Power Automate, Azure Functions (Python), and Azure SQL, containerizing supporting services with Docker to improve deployment consistency and reliability across environments.",
